...
# 运行前请先配置好相关参数，感谢您的使用！
# === 基本配置 ===
url = "https://tds.hycom.org/thredds/dodsC/GLBy0.08/expt_93.0/uv3z/2024"
outdir = Path("D:/data/HYCOM/Heichao_region/GLBy0.08") # 输出目录
...
# === 逐天保存为 npz ===
for day in pd.date_range("2024-01-01", "2024-06-22", freq="D"):
